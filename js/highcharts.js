...
(function() {
    ...
    var t, y = document,
        ...
        Za, $a, Kb = {}, tb = 0,
        db, F, cb, va, ub, z, sa = function() {}, V = [],
        ab = 0,
        Ja = "div",
        N = "none",
        Ob = /^[0-9]+$/,
        Pb = "stroke-width",
        eb, Ra, pb, qb, rb, Xa, fb, gb, Db, Eb, sb, Fb, Gb, G = {}, R = I.Highcharts = I.Highcharts ? ra(16, !0) : {};
    cb = function(a, b, c) {
        ...
        add: function(a) {
            ...
            if (c.handleZ) {
                ...
                for (g = 0; g < a.length; g++)
                    if (b = a[g], c = H(b, "zIndex"), b !== e && (A(c) > f || !r(f) && r(c))) {
                        d.insertBefore(e, b);
                        h = !0;
                        break
                    }
    ...
    U.prototype.translateXSetter = U.prototype.translateYSetter = U.prototype.rotationSetter = U.prototype.verticalAlignSetter = U.prototype.scaleXSetter = U.prototype.scaleYSetter =
        function(a, b) {
            this[b] = a;
            this.doTransform = !0
    };
    ...
    ta.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (Ta || ib) && y.getElementsByTagName("base").length ? f.href.replace(/#.*?$/, "").replace(/([\('\)])/g, "\\$1").replace(/ /g,
                "%20") : "";
        ...
        buildText: function(a) {
            for (var b = a.element, c = this, d = c.forExport, e = m(a.textStr, "").toString(),
                    f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = H(b, "x"), k = a.styles, l = a.textWidth, o = k && k.lineHeight, n = g.length, s = function(a) {
                        return o ? A(o) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12).h
                    }; n--;) b.removeChild(g[n]);
            !f && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), p(e, function(e, f) {
                var g, n = 0,
                ...
                p(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        i.test(e) && !d && (H(m, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                            D(m, {
                                cursor: "pointer"
                            }));
                        ...
                        if (e !== " ") {
                            ...
                            n++;
                            if (l)
                                for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), o = e.length > 1 && k.whiteSpace !== "nowrap", $, r, B = a._clipHeight, q = [], v = s(), t = 1; o && (e.length || q.length);) delete a.bBox, $ = a.getBBox(), r = $.width, !aa && c.forExport &&
                                    (r = c.measureSpanWidth(m.firstChild.data, a.styles)), $ = r > l, !$ || e.length === 1 ? (e = q, q = [], e.length && (t++, B && t * v > B ? (e = ["..."], a.attr("title", a.textStr)) : (m = y.createElementNS(xa, "tspan"), H(m, {
                                    dy: v,
                                    x: j
        ...
        symbols: {
            ...
            callout: function(a, b, c, d, e) {
                ...
                a += e;
                b += e;
                e = ["M", a + f, b, "L", a + c - f, b, "C", a + c, b, a + c, b, a + c, b + f, "L", a + c, b + d - f, "C", a + c, b + d,
                    a + c, b + d, a + c - f, b + d, "L", a + f, b + d, "C", a, b + d, a, b + d, a, b + d - f, "L", a, b + f, "C", a, b, a, b, a + f, b
                ];
        ...
        var ga = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = o.x1 || o[0] || 0, a = o.y1 || o[1] || 0, n = o.x2 || o[2] || 0, o = o.y2 || o[3] || 0, x = 'angle="' + (90 - T.atan((o - a) / (n - c)) * 180 / ma) + '"', q();
                        else {
                            var j = o.r,
                                t = j * 2,
                                u = j * 2,
                                ...
                                w, j = function() {
                                    ...
                                    x = 'src="' + F.global.VMLRadialGradientURL + '" size="' +
                                        t + "," + u + '" origin="0.5,0.5" position="' + y + "," + B + '" color2="' + Q + '" ';
                                    q()
                                };
                            d.added ? j() : d.onAdd = j;
                            j = J
        ...
        render: function(a, b, c) {
            ...
            if (s) {
                ...
                if (l === t) {
                    ...
                    if (b) l.opacity = 0;
                    this.gridLine =
                        l = s ? f.path(j).attr(l).add(d.gridGroup) : null
                }
            ...
            if (i && !isNaN(y)) i.xy = w = this.getLabelPosition(y, w, i, g, k, u, a, v), this.isFirst && !this.isLast && !m(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !m(e.showLastLabel, 1) ? q = !1 : !d.isRadial && !k.step && !k.rotation && !b &&
                c !== 0 && (q = this.handleOverflow(a, w)), v && a % v && (q = !1), q && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr" : "animate"](w), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Oa(this, this.axis)
        }
    ...
    la.prototype = {
        ...
        adjustForMinRange: function() {
            ...
            if (c - b < this.minRange) {
                ...
                c = Na(c);
                c - b < k &&
                    (d[0] = c - k, d[1] = m(a.min, c - k), b = Ba(d))
            }
            this.min = b;
            this.max = c
        },
        setAxisTranslation: function(a) {
            ...
            if (b.isXAxis || i || d) h ? (f = h.minPointOffset, g = h.pointRangePadding) : p(b.series, function(a) {
                ...
                e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = C(d, c), b.closestPointRange = e;
            if (a) b.oldTransA = j;
        ...
        setTickPositions: function(a) {
            ...
            h ? (b.linkedParent = c[b.coll][d.linkedTo],
                c = b.linkedParent.getExtremes(), b.min = m(c.min, c.dataMin), b.max = m(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ra(11, 1)) : (b.min = m(b.userMin, d.min, b.dataMin), b.max = m(b.userMax, d.max, b.dataMax));
            ...
            b.adjustForMinRange();
            if (!$ && !b.axisPointRange && !b.usePercentage && !h && r(b.min) && r(b.max) &&
                (c = b.max - b.min)) {
            ...
            if (v || h)
                if (a.minorTickInterval && !a.categories &&
                    p(a.getMinorTickPositions(), function(b) {
                        ...
                        w = b + J, z = i[c + 1] !== t ? i[c + 1] + J : a.max, n[b].options = {
                            from: g ? ia(w) : w,
                            to: g ? ia(z) : z,
                            color: m
    ...
    la.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            h = i[gb]();
            for (var d = i.getTime(), l = i[fb](), o = i[Xa](), n = g ? Ra : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d), j === z.year ? d = eb(h + b * k, 0) : j === z.month ? d = eb(h, l + b * k) : !g && (j === z.day || j === z.week) ? d = eb(h, l, o + b * k * (j === z.day ?
                1 : 7)) : d += j * k, b++;
            e.push(d);
            p(vb(e, function(a) {
    ...
    la.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (d = c[g], e = z[d[0]], f = d[1], c[g +
                1] && a <= (e * f[f.length - 1] + z[c[g + 1][0]]) / 2) break;
    ...
    la.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = u(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = S(b), h, i, j, k, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                i = e.length;
                for (h = 0; h < i && !l; h++) j = za(ia(f) * e[h]), j > b && (!d ||
    ...
    Mb.prototype = {
        ...
        refresh: function(a, b) {
            ...
            h = a.series;
            this.distance =
                m(h.tooltipOptions.distance, 16);
        ...
        updatePosition: function(a) {
            ...
            this.move(u(c.x),
                u(c.y), a.plotX + b.plotLeft, a.plotY + b.plotTop)
        },
    ...
    Wa.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                i = c.length;
                for (j = 0; j < i; j++)
                    if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = O(l - e.clientX),
        ...
        onContainerClick: function(a) {
            ...
            if (!b.cancelClick) c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, q(c, {
                ...
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && E(b, "click",
                a))
        },
    ...
    lb.prototype = {
        init: function(a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.baseline = A(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX =
                e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = m(b.symbolWidth, 16), c.pages = [], c.render(), K(c.chart, "endResize", function() {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker)
                    for (j in i.stroke =
                        h, g = a.convertAttribs(g), g) d = g[j], d !== t && (i[j] = d);
                f.attr(i)
            }
        },
        ...
        renderItem: function(a) {
            ...
            c = q.getBBox();
            f = a.legendItemWidth = d.itemWidth || a.legendItemWidth ||
    ...
    M.prototype = {
        ...
        drawPoints: function() {
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)
                for (f =
                    b.length; f--;)
                    if (g = b[f], d = S(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = s && i.enabled === t || i.enabled, o = c.isInsidePlot(u(d), e, c.inverted), a && e !== t && !isNaN(e) && g.y !== null)
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (D = 2; D--;) {
                ...
                if (l > 0) {
                    ...
                    for (B = 0; B < I; B++) {
                        ...
                        if (F < B && b[B] !== null) F = B;
                            ...
                            for (w < I - B + F && b[B] !== null && (F = w - I + B); b[F] === null;) F++;
                        K.push({
                            i: F,
                            y: b[F]
                        });
                ...
                for (B = 0; B < I; B++) {
                    ...
                    t.connX = z;
                    t.connY = C;
                    if (this.options.size === null) w = t.width, z - w < f ? E[3] = v(u(w - z + f), E[3]) : z + w > h - f && (E[1] = v(u(z + w - h + f), E[1])), C - y / 2 < 0 ? E[0] =
                        v(u(-C + y / 2), E[0]) : C + y / 2 > d && (E[2] = v(u(C + y / 2 - d), E[2]))
                }
            }
    ...
    if (G.gauge) G.gauge.prototype.drawTracker =
        P.drawTrackerPoint;
    q(lb.prototype, {
    ...
    q(Ya.prototype, {
        ...
        zoom: function(a) {
            ...
            b && this.redraw(m(this.options.chart.animation,
